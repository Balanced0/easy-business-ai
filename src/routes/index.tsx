...
function LanguageToggle() {
  ...
  return (
    ...
    >
      <span
        className={`px-2 py-1 ${lang === "bn" ? "bg-primary text-primary-foreground rounded-md" : "text-muted-foreground rounded-xl"}`}
      >
        বাং
      </span>
      <span
        className={`px-2 py-1 ${lang === "en" ? "bg-primary text-primary-foreground rounded-md" : "text-muted-foreground rounded-xl"}`}
      >
        En
      </span>
    </button>
