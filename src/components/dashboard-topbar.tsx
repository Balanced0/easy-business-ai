  ...
  return (
    <header className="sticky top-0 z-10 flex h-14 items-center gap-3 border-b bg-background/95 px-4 backdrop-blur">
      ...
      <div className="ml-auto flex items-center gap-2">
        ...
        >
          <span className={`px-2 py-1 ${lang === "bn" ? "bg-primary text-primary-foreground rounded" : "text-muted-foreground rounded-xl"}`}>বাং</span>
          <span className={`px-2 py-1 ${lang === "en" ? "bg-primary text-primary-foreground rounded" : "text-muted-foreground rounded-xl"}`}>En</span>
        </button>
        <Button
          variant="ghost"
          size="icon"
